...
enum AppLogger {
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "WebSnapshot",category: "Error")

    static func record(_ error: AppError,_ operation: String,_ targetURL: URL? = nil) {
